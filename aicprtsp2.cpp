...
// Em đã tìm hiểu được code này trên github và cảm thấy code rất phức tạp vì dùng cấu trúc dữ liệu linked-list
// Vì code quá phức tạp, em không thể thay đổi cấu trúc dữ liệu được nên sử dụng 90% code lấy từ github trên
